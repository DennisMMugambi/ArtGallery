...
@NonNullApi
public class ArtGalleryProjectDependency extends DelegatingProjectDependency {

    @Inject
    public ArtGalleryProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
